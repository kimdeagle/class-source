			...
			<div>
				...
				<form method="POST" action="/codestudy/member/login.do" id="form1">
					...
					<div class="loginbox panel panel-default">
						...
						<div class="panel-body">
							<ul class="list-group">
								<li class="list-group-item"><input type="text" id="id"
									name="id" required placeholder="ID" class="form-control">
								</li>
								<li class="list-group-item"><input type="password" id="pw"
									name="pw" required placeholder="Password" class="form-control">
								</li>
						...
						<!-- 테스트용 -->
						<button type="button" onclick="test('hong', '1234');">홍길동</button>
						<button type="button" onclick="test('amugae', '111');">아무개</button>
