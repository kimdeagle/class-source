				...
				<table class="table write">
					<tr>
						<td><input type="text" class="form-control"
							placeholder="subject" id="subject"></td>
					</tr>
					<tr>
						<td id="content"><textarea class="form-control" id="code"
								placeholder="code">package com.test.array;
        ...
        System.out.println(Arrays.toString(color));
					...
					<tr>
						<td><input type="number" min="1"
							class="linenumber form-control"> - <input type="number"
							min="1" class="linenumber form-control"> <input
							type="text" class="linecomment form-control"
				...
				<div class="btns btn-group">
					...
					<button type="button" class="btn btn-default"
						onclick="location.href='/codestudy/review/writeok.do';">
