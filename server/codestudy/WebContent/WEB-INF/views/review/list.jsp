...
<body>
	...
	<div class="main">
		...
		<div class="content col-sm-12 col-md-9">
			<div>
				<h1>
					코드 리뷰 <small>Review</small>
				</h1>

				<div class="itemreview">
					<div class="item">
						<div class="title">
							<span>자바 기본 클래스입니다.</span> <span>2020-01-01</span> <span>홍길동</span>
						</div>
						<pre class="code">
<div>
								<span class="linenumber">1:</span>package java.io.*;</div>
<div>
								<span class="linenumber">2:</span>public class Hello {</div>
<div>
								<span class="linenumber">3:</span>    public static void main(String[] args) {</div>
<div>
								<span class="linenumber">4:</span>        System.out.println("안녕하세요.");</div>
<div>
								<span class="linenumber">5:</span>   }</div>
<div>
								<span class="linenumber">6:</span>}</div>
						</pre>
					</div>

					<div class="review">
						<div class="item" data-line-start="1" data-line-end="1">
							<span class="linenumber label label-primary">1 : 1</span> <span
								class="text">패키지 선언입니다.</span>
						</div>
						<div class="item" data-line-start="2" data-line-end="6">
							<span class="linenumber label label-primary">2 : 6</span> <span
								class="text">클래스 선언입니다.</span>
						</div>
						<div class="item" data-line-start="3" data-line-end="5">
							<span class="linenumber label label-primary">3 : 5</span> <span
								class="text">메인 메소드 선언입니다.메인 메소드 선언입니다.메인 메소드 선언입니다.메인
								메소드 선언입니다.</span>
						</div>
						<!-- 
...
<div>
					...
					<div class="review">
						...
						<div class="item" data-line-start="3" data-line-end="5">
							<span class="linenumber label label-primary">3 : 5</span> <span
								class="text">메인 메소드 선언입니다.메인 메소드 선언입니다.메인 메소드 선언입니다.메인
								메소드 선언입니다. 메인 메소드 선언입니다.메인 메소드 선언입니다.</span>
						</div>
						<!-- 
                        <div class="item" data-line-start="0">
                            <span class="linenumber label label-default">clear</span>
				...
				<div class="btns btn-group">
					<button type="button" class="btn btn-default"
						onclick="location.href='/codestudy/review/list.do';">
						<span class="glyphicon glyphicon-th-list"></span> 목록
					</button>
					<button type="button" class="btn btn-default"
						onclick="location.href='/codestudy/review/write.do';">
						<span class="glyphicon glyphicon-plus"></span> 쓰기
					</button>
				</div>
				<div style="clear: both;"></div>
			</div>
