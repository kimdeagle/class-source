		...
		<div class="content col-sm-12 col-md-9">
			<div>
				...
				<form method="POST" action="/codestudy/board/writeok.do"
					...
					<table class="table write">
						...
						<tr>
							<td><textarea class="form-control" id="content"
									placeholder="content" name="content" required></textarea></td>
						</tr>
						<tr>
							<td><input type="file" class="form-control"
								placeholder="file" id="file" name="attach"></td>
						</tr>
					</table>
					...
					<input type="hidden" name="reply" value="${reply}"> <input
						type="hidden" name="thread" value="${thread}"> <input
