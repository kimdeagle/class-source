...
<body>
		...
		<div class="content col-sm-12 col-md-9">
			<div>
				...
				<div style="min-height: 747px">
					...
					<input type="button" id="btn2" value="연결하기"> <input
						type="button" id="btn3" value="종료하기" disabled> <br>
					<br> <input type="text" id="message" disabled> <br>
					<br>
					<div id="output2"></div>
	...
	<script>
		...
		function print(msg) {
			$("#output2").prepend("<div>["+ (new Date()).toLocaleTimeString() +"] "+ msg +"</div>");
		}
