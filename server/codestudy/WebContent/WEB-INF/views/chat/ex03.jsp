					...
					<table class="table table-bordered" style="width: 500px;">
						<tr>
							...
							<td>
								...
								<button type="button" id="btnDisconnect" class="btn btn-default"
									disabled>종료하기</button>
							</td>
						</tr>
						<tr>
							<td colspan="2">
								<div id="output"
									style="width: 100%; height: 300px; padding: 15px; overflow: auto;"></div>
							</td>
						</tr>
						<tr>
							<td colspan="2"><input type="text" name="message"
								id="message" placeholder="대화내용을 입력하세요." class="form-control"
								disabled></td>
						</tr>
					</table>
