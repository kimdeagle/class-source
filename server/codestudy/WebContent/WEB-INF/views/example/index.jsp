...
<body>
	...
	<div class="main">
		...
		<div class="content col-sm-12 col-md-9">
			<div>
				<h1>
					수업 예제 <small>Example</small>
				</h1>

				<div class="list">
					<div class="folder">
						<span class="glyphicon glyphicon-folder-close"></span> sub
					</div>
					<div class="file">
						<span class="glyphicon glyphicon-file"></span> ex01.jsp
					</div>
					<div class="file">
						<span class="glyphicon glyphicon-file"></span> ex02.jsp
					</div>
					<div class="file">
						<span class="glyphicon glyphicon-file"></span> ex03.jsp
					</div>
					<div class="folder">
						<span class="glyphicon glyphicon-folder-close"></span>member
					</div>
					<div class="file">
						<span class="glyphicon glyphicon-file"></span> add.jsp
					</div>
					<div class="file">
						<span class="glyphicon glyphicon-file"></span> addok.jsp
					</div>
					<div class="file">
						<span class="glyphicon glyphicon-file"></span> remove.jsp
					</div>
				</div>
