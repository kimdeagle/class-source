		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<ul class="list-group">
						<li class="list-group-item"><input type="date"
							class="form-control" id="itemDate"></li>
						<li class="list-group-item"><input type="text"
							class="form-control" id="itemText"></li>
						<li class="list-group-item"><input type="text"
							class="form-control" id="itemUser" value="홍길동"></li>
					</ul>
				</div>
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-default" data-dismiss="modal">
						<span class="glyphicon glyphicon-ok"></span> 닫기
					</button>
				</div>
			</div>
		</div>
