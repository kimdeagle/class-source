...
public class MemberDAO {
	...
	public void updateState(String seq) {
	...
	public ArrayList<BarDTO> getBar() {
		...
		try {
			...
			String sql = "select count(*) as cnt, mseq, (select name from tblMember where seq = tblBoard.mseq) as name from tblBoard group by mseq having count(*) > 30 order by mseq asc";
	...
	public ArrayList<PiDTO> getPi() {
		...
		try {
			...
			String sql = "select count(*) as cnt, mseq, (select name from tblMember where seq = tblComment.mseq) as name from tblComment group by mseq order by mseq asc";
